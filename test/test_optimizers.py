...
from src.blackbox_functions import ackley
...
class TestBayesianOptimizer(TestCase):
    def test_initial_sampling(self):
        def square_with_cs(config: CS.Configuration):
        ...
        initial_points = 2
        bo = BayesianOptimization(obj_func=square_with_cs, config_space=cs, initial_points=initial_points, eps=0.001)
        bo.sample_new_points(0)
    ...
    def test_find_max_optimum(self):
        ...
        initial_points = 20
        bo = BayesianOptimization(obj_func=neg_square_with_cs, config_space=cs, initial_points=initial_points, eps=0,
                                  minimize_objective=False)
        best_config = bo.sample_new_points(500)
    ...
    def test_find_min_optimum(self):
        ...
        initial_points = 1
        bo = BayesianOptimization(obj_func=square_with_cs, config_space=cs, initial_points=initial_points, eps=0,
