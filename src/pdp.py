...
class PDP:
    ...
    def calculate_ice(self, idx: int, ordered=True, centered=False) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def calculate_pdp(self, idx: int, centered=False) -> Tuple[np.ndarray, np.ndarray]:
        # get all ice curves
        x_ice, y_ice = self.calculate_ice(idx, ordered=True, centered=centered)
